...
{
    public class UserLogExceptionsConsumerService : BackgroundService
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<UserLogExceptionsConsumerService> _logger;
        private readonly RabbitMQSetting _rabbitMqSetting;
        private IConnection _connection;
        private IModel _channel;

        public UserLogExceptionsConsumerService(IOptions<RabbitMQSetting> rabbitMqSetting,
                                                   IServiceProvider serviceProvider,
                                                   ILogger<UserLogExceptionsConsumerService> logger)
        {
